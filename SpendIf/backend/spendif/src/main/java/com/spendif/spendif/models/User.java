...
@Entity
@Table(name = "users")  // Table name explicitly set
public class User {
    ...
    @Column
    private String homeCountry; // e.g., "UAE"

    @Column
    private double averageTransactionAmount; // Average spending amount

    @Column
    private boolean dormant; // true if the account has been inactive
